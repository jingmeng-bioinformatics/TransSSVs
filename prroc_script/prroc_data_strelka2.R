...
file_mutect2_snp <- read.table(paste(file_path,name,'_snp_0.vcf',sep=''),sep='\t')
...
#file_mutect2_indel[,12]=gsub(".*SomaticEVS=","", file_mutect2_indel[, 8])
...
write.table(indel_data,paste('figure/roc/data/data/strelka2_',name,'_indel.txt',sep=''),row.names=F,col.names=F,sep='\t',quote=F)
