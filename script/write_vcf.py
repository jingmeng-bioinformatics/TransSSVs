...
def main(args):
    with open(args.Candidate_somatic_sites, 'rt') as Cs, open(args.pred_class, 'rt') as pc, open(args.vcf_file, 'wt') as vcf:
        ...
        for line, line_pair in zip(enume_Cs, enume_pc):
            ...
            if float(line_pair_content[0]) >= 0.5: 
                ...
                if re.search('\-[0-9]+', line_content[4]):
                    ...
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        str(line_content[4].upper()) + '\t' + str(line_content[3].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('PASS') + 
                ...
                # write insertions
                    ...
                    line_content[4] = re.sub('\+[0-9]+', '', line_content[4])
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        '\t' + str(line_content[3].upper()) + str(line_content[4].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('PASS') + 
                        '\t' + str('DP') + str('=') + str(line_content[5]) + str(';') + str('VAF') + str('=') + str(int(line_content[6])/int(line_content[5])) +
                        str(';') + str('AD') + str('=') + str(line_content[6]) + '\t')
                ...
                # write SNVs
                    ...
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        '\t' + str(line_content[4].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('PASS') + '\t' + 
                        str('DP') + str('=') + str(line_content[5]) + str(';') + str('VAF') + str('=') + str(int(line_content[6])/int(line_content[5])) +
                        str(';') + str('AD') + str('=') + str(line_content[6]) + '\t')
                    ...
                    if int(line_content[6])/int(line_content[5]) <= 0.5:
                        ...
                        vcf.write(str('GT') + '\t' + str('1/0') + '\n')
            elif float(line_pair_content[0]) < 0.5 and float(line_pair_content[0]) >= t:
                # write deletions
                if re.search('\-[0-9]+', line_content[4]):
                    line_content[4] = re.sub('\-[0-9]+', '', line_content[4])
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        str(line_content[4].upper()) + '\t' + str(line_content[3].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('LOWQ') + 
                        '\t' + str('DP') + str('=') + str(line_content[5]) + str(';') + str('VAF') + str('=') + str(int(line_content[6])/int(line_content[5])) +
                        str(';') + str('AD') + str('=') + str(line_content[6]) + '\t')
                ...
                # write insertions
                    ...
                    line_content[4] = re.sub('\+[0-9]+', '', line_content[4])
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        '\t' + str(line_content[3].upper()) + str(line_content[4].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('LOWQ') + 
                        '\t' + str('DP') + str('=') + str(line_content[5]) + str(';') + str('VAF') + str('=') + str(int(line_content[6])/int(line_content[5])) +
                        str(';') + str('AD') + str('=') + str(line_content[6]) + '\t')
                ...
                # write SNVs
                    ...
                    vcf.write(line_content[1] + '\t' + line_content[2] + '\t' + str('.') + '\t' + str(line_content[3].upper()) + 
                        '\t' + str(line_content[4].upper()) + '\t' + str(line_pair_content[0]) + '\t' + str('LOWQ') + '\t' + 
                        str('DP') + str('=') + str(line_content[5]) + str(';') + str('VAF') + str('=') + str(int(line_content[6])/int(line_content[5])) +
                        str(';') + str('AD') + str('=') + str(line_content[6]) + '\t')
